...
import Loading from './Loading';
    ...
    async componentDidMount() {
        ...
        this.timer = setInterval(this.tick, 1000);
        console.log("question => " + this.state.quiz[1].question);
        console.log("code => " + this.state.quiz[0].code.code)
        console.log("answers array => " + this.state.quiz[0].answers)
        console.log("answer id => " + this.state.quiz[0].answers[0].id)
    }
                    ...
                    {this.state.quizDone ? (<div className="popup"><Score action={this.restart.bind(this)} score={this.state.score}/></div>) : null}
                        ...
                        <div className="toprow">
                            ...
                            <div className="Column">
                                <h3>Code</h3>
                                <Code code={this.state.quiz[0].code.code}/>
                            </div> 
                        </div>                   
                    </div>
                )
